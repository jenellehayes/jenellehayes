      ...
      <main className="bg-primary text-white min-h-screen px-4 sm:px-10 py-10 grid place-content-center">
        <div className="grid md:grid-cols-2 md:gap-14 max-w-5xl font-thin">
          <div>
            ...
            <div>
              <h2>Projects I Do</h2>
              <p>Create <strong>visual identities</strong> and <strong>brand 
standards</strong>. <strong>Digital</strong> designs, including responsive 
<strong>websites</strong> made with <strong>accessibility</strong>, <strong>user 
...
a <strong>cookbook</strong>.</p>
            </div>
          </div>
          <div>
            <h2>Work &amp; Projects</h2>
            <p>Nerder, Miller Thomson LLP, Rundle College, Blake, Cassels &amp; Graydon LLP, Calgary Counselling Centre, and the Government of Alberta.</p>
            <h2>About</h2>
            <p>Crafting in my homeland of <strong>Canada</strong> &#45; on traditional and ancestral territories of Treaty 7 and the Blackfoot Confederacy: Kainai, Piikani and Siksika, as well as the Tsuu T&apos;ina Nation and Stoney Nakoda First Nation, where I honour the histories, languages, and cultures of First Nations, Metis, Inuit, and all First Peoples of Canada &#45; I make with passion and care. Outside of honing my skills, I enjoy exploring nature, attending the orchestra, and visiting an art gallery or a museum. I care about the environment and limit my impact on it. I&apos;m formally trained in new media production and design, as well as print communications. <a href="https://drive.google.com/file/d/1sivzGO4B_5gr6uK23qG3UfiwEuuPLp6r/view" className="font-medium italic"> <u>Portfolio</u> coming soon! </a> </p>
          </div>
        </div>
      </main>
    </>
