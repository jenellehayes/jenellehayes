        ...
        <div className="grid md:grid-cols-2 md:gap-14 max-w-5xl font-thin">
          <div>
            ...
            <div>
              <h2>Projects I Do</h2>
              <p>
                Create <strong>visual identities</strong> and <strong>brand standards</strong>, including <strong>logo design</strong>. <strong>Digital</strong> designs, including responsive <strong>websites</strong> made with <strong>accessibility</strong>, <strong>user experience</strong> and best practices in mind, such as <strong>SEO</strong> and <strong>information architecture</strong>. Fluent with all <strong>Adobe</strong> products, <strong>Figma</strong>, and I&apos;m currently learning <strong>Webflow</strong>. I&apos;ve developed <strong>social media strategies</strong>, template sets, mood boards, </strong>wireframes</strong>, and <strong>mockups</strong>. Print too! Experience with <strong>business cards</strong>, <strong>editorial</strong> layouts, <strong>adverts</strong>, <strong>signage</strong>, government and legal <strong>textbooks</strong>, and a <strong>cookbook</strong>.
            </p>
            </div>
          </div>
          <div>
