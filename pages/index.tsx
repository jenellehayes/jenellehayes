  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Crafting visual identities and well-thought web designs. Available for new projects in early February 2023."
        />
      </Head>
      <main className="bg-primary text-white min-h-screen px-4 sm:px-10 py-10 grid place-content-center">
        <div className="grid md:grid-cols-2 md:gap-14 max-w-5xl font-thin">
          <div>
            ...
            <p>
              Available to take on new projects in early February 2023. If you are
